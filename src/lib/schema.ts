...
export const projects = sqliteTable("projects", {
  ...
  color: text("color"),
  workingMethod: text("working_method").default("auto"), // 'auto' | 'claude-code' | 'vscode' | 'opencode' | 'cursor' | 'cursor-agent' | 'copilot-cli' | 'codex'
...
export const settings = sqliteTable("settings", {
  ...
  defaultWorkingMethod: text("default_working_method").default("auto"), // Default environment for new projects: 'auto' | 'claude-code' | 'vscode' | 'opencode' | 'cursor' | 'cursor-agent' | 'copilot-cli' | 'codex'
