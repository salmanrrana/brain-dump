...
describe("useKeyboardShortcuts", () => {
  ...
  describe("Acceptance Criteria", () => {
    ...
    it("should call onNavigateHome when '1' is pressed", () => {
    ...
    it("should call onNavigateDashboard when '2' is pressed", () => {
    ...
    it("should call onNavigateBoard when '3' is pressed", () => {
    ...
    it("should NOT trigger navigation shortcuts when disabled", () => {
      const onNavigateHome = vi.fn();
      renderHook(() => useKeyboardShortcuts({ onNavigateHome, disabled: true }));
...
describe("KEYBOARD_SHORTCUTS constant", () => {
  ...
  it("should include '1' shortcut for Home navigation", () => {
    const shortcut = KEYBOARD_SHORTCUTS.find((s) => s.key === "1");
    expect(shortcut).toBeDefined();
    expect(shortcut?.category).toBe("navigation");
    expect(shortcut?.description.toLowerCase()).toContain("home");
  });

  it("should include '2' shortcut for Dashboard navigation", () => {
  ...
  it("should include '3' shortcut for Board navigation", () => {
