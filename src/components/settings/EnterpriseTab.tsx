 ...
 */
export function EnterpriseTab({ isActive, form }: EnterpriseTabProps) {
  return (
    <div
    ...
    >
      <div className="space-y-6">
        ...
        <div>
          ...
          {/* Retention Period */}
          <form.Subscribe
            selector={(state: { values: { conversationLoggingEnabled: boolean } }) =>
              state.values.conversationLoggingEnabled
            }
                  ...
                  <div className="mt-4">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        if (!isNaN(value)) {
                          field.handleChange(Math.max(7, Math.min(365, value)));
                        }
                      }}
                      onBlur={field.handleBlur}
                      className={
                        inputStyles.base + " disabled:opacity-50 disabled:cursor-not-allowed"
                      }
                ...
                <div className="mt-4 p-3.5 bg-[color-mix(in_srgb,var(--status-warning)_10%,transparent)] border border-[color-mix(in_srgb,var(--status-warning)_30%,transparent)] rounded-xl">
                  <div className="flex items-center gap-2.5">
                    ...
                    <p className="text-xs text-[var(--status-warning)]">
                      <strong>Enterprise feature:</strong> Creates an audit trail of all AI
                      interactions for compliance requirements.
                    </p>
                  </div>
                </div>
              ) : null
