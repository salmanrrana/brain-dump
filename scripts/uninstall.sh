...
echo ""
echo -e "${BLUE}To remove data and backups, use the root uninstall script:${NC}"
echo "  ./uninstall.sh --all          (removes everything including backups)"
echo "  ./uninstall.sh --keep-backup  (removes everything, keeps backups)"
echo ""
