...
echo ""
echo -e "  ${GREEN}Recommended for Ralph/autonomous runs:${NC}"
echo "    copilot --yolo"
echo ""
echo -e "  ${GREEN}Auto-approve all tools (verbose form):${NC}"
...
echo ""
echo -e "${YELLOW}Note:${NC} If workflow tools look stale, rebuild and restart the MCP server:"
echo "  cd $BRAIN_DUMP_DIR/mcp-server && pnpm build"
echo "  Then start a new Copilot CLI session"
echo ""
