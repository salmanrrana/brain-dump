...
CREATE INDEX `idx_tool_usage_last_used` ON `tool_usage_events` (`last_used_at`);--> statement-breakpoint
ALTER TABLE `settings` ADD `enable_worktree_support` integer DEFAULT false;